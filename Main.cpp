...
//"void main()\n"
//"{\n"
//"   FragColor = vec4(0.0f, 0.75f, 0.0f, 1.0f);\n"
//"}\n\0";
...
int main()
{
   ...
   // GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Render Window", NULL, NULL);
    ...
    ////Specify where our Shader Code can be found
    ...
    //if (!success)
    //{
    //    //Get any errors/info from VertexShader
    ...
    //if (!success)
    //{
    //    //Get any errors/info from Fragment Shader
    ...
    //}
    ////Delete Shader Objects, once they've been linked to our Program
